...
public class ActionBo extends BaseEntity {
     ...
     * 批次描述
     */
    //@NotBlank(message = "批次描述不能为空", groups = { AddGroup.class, EditGroup.class })
     ...
     * 使用起始日期
     */
    @NotNull(message = "使用起始日期不能为空", groups = { AddGroup.class, EditGroup.class })
    private Date periodOfStart;

    /**
     * 使用有效截止日期
     */
    @NotNull(message = "使用有效截止日期不能为空", groups = { AddGroup.class, EditGroup.class })
     ...
     * 可兑换起始日期
     */
    @NotNull(message = "可兑换起始日期不能为空", groups = { AddGroup.class, EditGroup.class })
    private Date conversionStartDate;

    /**
     * 可兑换截止日期
     */
    @NotNull(message = "可兑换截止日期不能为空", groups = { AddGroup.class, EditGroup.class })
