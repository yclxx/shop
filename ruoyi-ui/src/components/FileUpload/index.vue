<template>
  <div class="upload-file">
    <el-upload multiple :action="uploadFileUrl" :before-upload="handleBeforeUpload" :file-list="fileList" :limit="limit"
      ...
      <el-link type="info" style="font-size:12px;margin-left: 20px;" v-if="isShowDownloadTemplate"
        @click.stop="downloadTemplate">下载模板</el-link>
      <!-- 上传提示 -->
...
<script>
  ...
  export default {
    ...
    props: {
      ...
      fileType: {
        type: Array,
        default: () => ["doc", "xls", "ppt", "txt", "pdf", "html"],
      },
      // 是否显示提示
      isShowTip: {
        type: Boolean,
