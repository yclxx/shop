  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="系统模块" prop="title">
        ...
        <el-select v-model="queryParams.title" placeholder="系统模块" clearable style="width: 240px">
          <el-option v-for="dict in dict.type.t_system_type" :key="dict.value" :label="dict.label"
            :value="dict.value" />
        </el-select>
      </el-form-item>
...
<script>
  ...
  export default {
    name: "Operlog",
    dicts: ['sys_oper_type', 'sys_common_status', 't_system_type'],
    data() {
      return {
        // 遮罩层
        loading: true,
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        this.queryParams.operatorType = 2;
