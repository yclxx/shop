    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                   v-hasPermi="['zlyyh:shop:add']">新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
                   v-hasPermi="['zlyyh:shop:edit']">修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
                   v-hasPermi="['zlyyh:shop:remove']">删除
        </el-button>
      </el-col>
      <!--      <el-col :span="1.5">-->
      <!--        <el-button type="info" plain icon="el-icon-upload2" size="mini" @click="handleImport"-->
      <!--                   v-hasPermi="['zlyyh:shop:import']">导入-->
      <!--        </el-button>-->
      <!--      </el-col>-->
      <!--      <el-col :span="1.5">-->
      <!--        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"-->
      <!--                   v-hasPermi="['zlyyh:shop:export']">导出-->
      <!--        </el-button>-->
      <!--      </el-col>-->
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleMerNoEdit(scope.row)"
                     v-hasPermi="['zlyyh:shop:merNoEdit']">商户号配置
          </el-button>
          ...
          <el-col :span="12">
            <el-form-item label="展示区间" prop="sellTime">
              <el-time-picker is-range v-model="form.sellTime" range-separator="-" start-placeholder="开始时间"
                              end-placeholder="结束时间" placeholder="选择时间范围" style="width: 90%;"
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleShopMerchantAdd"
                     v-hasPermi="['zlyyh:shopMerchant:add']">新增
          </el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple"
                     @click="handleShopMerchantDelete" v-hasPermi="['zlyyh:shopMerchant:remove']">删除
          </el-button>
        </el-col>
  ...
  methods: {
    ...
    getList() {
      if (this.businessDistrictId) {
        this.queryParams.businessDistrictId = this.businessDistrictId;
      }
      this.loading = true;
    ...
    submitForm() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          ...
          this.form.businessDistrictId = this.businessDistrictId;
