<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button v-show="isBusiness === true" plain size="mini" @click="handleShop(0)">选择门店
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button v-show="isBusiness === true" :loading="buttonLoading" type="danger" plain
                   icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete">解除关联
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button v-show="isBusiness === false" plain size="mini" @click="handleShop(1)">查看门店
        </el-button>
      </el-col>
      <el-col :span="1.5">
...
export default {
  ...
  methods: {
    ...
    handleAddShop() {
      ...
      this.$modal.confirm('解除门店编号为"' + shopIds + '"与商圈的关系？').then(() => {
        this.loading = true;
        const param = {
          'shopIds': shopIds,
          'businessDistrictId': this.businessDistrictId
