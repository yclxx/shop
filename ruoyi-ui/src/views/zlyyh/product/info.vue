        ...
        <el-tabs v-model="activeName">
          <el-tab-pane label="基本信息" name="basicCoupon" key="basicCoupon" :style="{height: tableHeight}">
            <el-row>
              ...
              <el-col :span="8"
                      v-if="form.productAffiliation && form.productAffiliation == '0' && form.productType != '13'">
              ...
              <el-col :span="8"
                      v-if="form.productAffiliation && form.productAffiliation == '0' && form.unionPay == '1' && form.productType != '13'">
