      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="120">
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.productType == '13'" size="mini" type="text" icon="el-icon-edit"
                     @click="handleTicketSessionLine(scope.row)"
                     v-hasPermi="['zlyyh:product:ticket']">场次与票种
          </el-button>
        </template>
      </el-table-column>
    </el-table>
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="门店组" prop="shopGroupId">
                  <el-select v-model="form.shopGroupId" placeholder="请选择门店组" filterable clearable
                             style="width: 100%;">
