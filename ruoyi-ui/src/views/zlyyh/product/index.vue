              ...
              <el-col :span="8" v-if="form.productAffiliation && form.productAffiliation == '0'">
                <el-form-item label="售卖结束时间" prop="sellEndDate">
                  <el-date-picker clearable v-model="form.sellEndDate" type="datetime" style="width: 100%;"
                                  value-format="yyyy-MM-dd HH:mm:ss" placeholder="请选择售卖结束时间"
                                  default-time="23:59:59">
                  </el-date-picker>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="8" v-if="form.productAffiliation && form.productAffiliation == '0'">
                <el-form-item label="使用结束时间" prop="usedEndTime">
                  <el-date-picker clearable v-model="form.usedEndTime" type="datetime" style="width: 100%;"
                                  value-format="yyyy-MM-dd HH:mm:ss" placeholder="请选择使用结束时间"
                                  default-time="23:59:59">
                  </el-date-picker>
                </el-form-item>
              </el-col>
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label="门店" prop="shopId">
                  <el-select v-model="form.shopId" placeholder="请输入门店名称搜索" multiple filterable remote
                             reserve-keyword
              ...
              <el-table-column type="expand">
                <template slot-scope="props">
                  <el-table :data="props.row.ticketLine">
                    ...
                    <el-table-column :render-header="renderHeader" label="第三方id" align="center" prop="lineTitle">
                      <template slot-scope="scope">
                    ...
                    <el-table-column label="操作" align="center">
                      <template slot-scope="scope">
                        <el-button size="mini" type="text" icon="el-icon-delete"
                                   @click="delLineRow(props.row,scope.row)"
