  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="品牌名称" prop="commercialTenantName">
        <el-input
          v-model="queryParams.commercialTenantName"
          placeholder="请输入品牌名称"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="云闪付手机号" prop="upMobile">
        <el-input
          v-model="queryParams.upMobile"
          placeholder="请输入云闪付手机号"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['zlyyh:shareUser:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    >
      ...
      <el-table-column label="云闪付手机号" align="center" prop="upMobile" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['zlyyh:shareUser:edit']"
          >修改</el-button>
          <el-button
            size="mini"
            type="text"
          ...
          <el-button
            ...
            v-hasPermi="['zlyyh:shareUser:remove']"
          >删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="上级ID" prop="parentId">
          <treeselect v-model="form.parentId" :options="shareUserOptions" :normalizer="normalizer" placeholder="请选择上级ID" />
        </el-form-item>
        <el-form-item label="平台标识" prop="platformKey">
...
<script>
import { listShareUser, getShareUser, delShareUser, addShareUser, updateShareUser } from "@/api/zlyyh/shareUser";
  ...
  methods: {
    ...
    getTreeselect() {
      listShareUser().then(response => {
        ...
        const data = { userId: 0, businessDistrictName: '顶级节点', children: [] };
