  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="银联任务ID" prop="upMissionId">
        <el-input
          v-model="queryParams.upMissionId"
          placeholder="请输入银联任务ID"
          clearable
      ...
      <el-form-item label="银联任务组ID" prop="upMissionGroupId">
        <el-input
          v-model="queryParams.upMissionGroupId"
          placeholder="请输入银联任务组ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="银联任务用户id" prop="upMissionUserId">
        <el-input
          v-model="queryParams.upMissionUserId"
          placeholder="请输入银联任务用户id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="当日进度" prop="dayProgress">
        <el-input
          v-model="queryParams.dayProgress"
          placeholder="请输入当日进度"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="本周进度" prop="weekProgress">
        <el-input
          v-model="queryParams.weekProgress"
          placeholder="请输入本周进度"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="本月进度" prop="monthProgress">
        <el-input
          v-model="queryParams.monthProgress"
          placeholder="请输入本月进度"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="活动总进度" prop="activityProgress">
        <el-input
          v-model="queryParams.activityProgress"
          placeholder="请输入活动总进度"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['zlyyh:unionpayMissionProgress:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['zlyyh:unionpayMissionProgress:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['zlyyh:unionpayMissionProgress:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['zlyyh:unionpayMissionProgress:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listUnionpayMissionProgress, getUnionpayMissionProgress, delUnionpayMissionProgress, addUnionpayMissionProgress, updateUnionpayMissionProgress } from "@/api/zlyyh/unionpayMissionProgress";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        progressId: [
          { required: true, message: "任务进度ID不能为空", trigger: "blur" }
        ],
        upMissionId: [
          { required: true, message: "银联任务ID不能为空", trigger: "blur" }
        ],
        upMissionGroupId: [
          { required: true, message: "银联任务组ID不能为空", trigger: "blur" }
        ],
        upMissionUserId: [
          { required: true, message: "银联任务用户id不能为空", trigger: "blur" }
        ],
        dayProgress: [
          { required: true, message: "当日进度不能为空", trigger: "blur" }
        ],
        weekProgress: [
          { required: true, message: "本周进度不能为空", trigger: "blur" }
        ],
        monthProgress: [
          { required: true, message: "本月进度不能为空", trigger: "blur" }
        ],
        activityProgress: [
          { required: true, message: "活动总进度不能为空", trigger: "blur" }
        ],
      }
    };
  },
