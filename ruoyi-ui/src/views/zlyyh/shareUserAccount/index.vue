  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="冻结金额" prop="freezeBalance">
        <el-input v-model="queryParams.freezeBalance" placeholder="请输入冻结金额" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="可提金额" prop="balance">
        <el-input v-model="queryParams.balance" placeholder="请输入可提金额" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="已提金额" prop="withdrawDeposit">
        <el-input v-model="queryParams.withdrawDeposit" placeholder="请输入已提金额" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="已退金额" prop="refundBalance">
        <el-input v-model="queryParams.refundBalance" placeholder="请输入已退金额" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['zlyyh:shareUserAccount:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['zlyyh:shareUserAccount:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['zlyyh:shareUserAccount:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['zlyyh:shareUserAccount:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="shareUserAccountList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否可提现" align="center" prop="status" />
...
<script>
  import {
    listShareUserAccount,
    getShareUserAccount,
    delShareUserAccount,
    addShareUserAccount,
    updateShareUserAccount
  } from "@/api/zlyyh/shareUserAccount";
