    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['zlyyh:productAmount:add']"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['zlyyh:productAmount:edit']"
        >修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['zlyyh:productAmount:remove']"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['zlyyh:productAmount:export']"
        >导出
        </el-button>
      </el-col>
    ...
    return {
      ...
      rules: {
        ...
        externalProductSendValue: [
          {required: true, message: "发放金额，不能为空", trigger: "blur"}
        ],
        drawProbability: [
