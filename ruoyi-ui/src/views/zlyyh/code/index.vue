  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="场次ID" prop="productSessionId">
        <el-input v-model="queryParams.productSessionId" placeholder="请输入场次ID" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="规格ID" prop="productSkuId">
        <el-input v-model="queryParams.productSkuId" placeholder="请输入规格ID" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="场次名称" prop="productSessionName">
        <el-input v-model="queryParams.productSessionName" placeholder="请输入场次名称" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="规格名称" prop="productSkuName">
        <el-input v-model="queryParams.productSkuName" placeholder="请输入规格名称" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="券号" prop="codeNo">
        <el-input v-model="queryParams.codeNo" placeholder="请输入券号" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="分配状态：0-未分配，1-已分配" prop="allocationState">
        <el-select v-model="queryParams.allocationState" placeholder="请选择分配状态：0-未分配，1-已分配" clearable>
          <el-option v-for="dict in dict.type.t_code_allocation_state" :key="dict.value" :label="dict.label"
            :value="dict.value" />
        </el-select>
      </el-form-item>
      <el-form-item label="所属订单号" prop="number">
        <el-input v-model="queryParams.number" placeholder="请输入所属订单号" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="核销状态：0-未核销，1-已核销，2-已失效，3-已作废" prop="usedStatus">
        <el-select v-model="queryParams.usedStatus" placeholder="请选择核销状态：0-未核销，1-已核销，2-已失效，3-已作废" clearable>
          <el-option v-for="dict in dict.type.t_code_used_status" :key="dict.value" :label="dict.label"
            :value="dict.value" />
        </el-select>
      </el-form-item>
      <el-form-item label="券码类型：0-系统券码，1-外部券码" prop="codeType">
        <el-select v-model="queryParams.codeType" placeholder="请选择券码类型：0-系统券码，1-外部券码" clearable>
          <el-option v-for="dict in dict.type.t_code_type" :key="dict.value" :label="dict.label" :value="dict.value" />
        </el-select>
      </el-form-item>
      <el-form-item label="核销或作废时间" prop="usedTime">
        <el-date-picker clearable v-model="queryParams.usedTime" type="date" value-format="yyyy-MM-dd"
          placeholder="请选择核销或作废时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="核销店铺ID" prop="shopId">
        <el-input v-model="queryParams.shopId" placeholder="请输入核销店铺ID" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="核销店铺名称" prop="shopName">
        <el-input v-model="queryParams.shopName" placeholder="请输入核销店铺名称" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="核销人员ID" prop="verifierId">
        <el-input v-model="queryParams.verifierId" placeholder="请输入核销人员ID" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="核销人员手机号" prop="verifierMobile">
        <el-input v-model="queryParams.verifierMobile" placeholder="请输入核销人员手机号" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="二维码图片URL" prop="qrcodeImgUrl">
        <el-input v-model="queryParams.qrcodeImgUrl" placeholder="请输入二维码图片URL" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="预约店铺ID" prop="appointmentShopId">
        <el-input v-model="queryParams.appointmentShopId" placeholder="请输入预约店铺ID" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="预约店铺名称" prop="appointmentShopName">
        <el-input v-model="queryParams.appointmentShopName" placeholder="请输入预约店铺名称" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="预约时间" prop="appointmentDate">
        <el-date-picker clearable v-model="queryParams.appointmentDate" type="date" value-format="yyyy-MM-dd"
          placeholder="请选择预约时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="预约状态：0-未预约，1-已预约，2-已取消" prop="appointmentStatus">
        <el-select v-model="queryParams.appointmentStatus" placeholder="请选择预约状态：0-未预约，1-已预约，2-已取消" clearable>
          <el-option v-for="dict in dict.type.appointment_status" :key="dict.value" :label="dict.label"
            :value="dict.value" />
        </el-select>
      </el-form-item>
      <el-form-item label="预约时间ID" prop="appointmentId">
        <el-input v-model="queryParams.appointmentId" placeholder="请输入预约时间ID" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="部门id" prop="sysDeptId">
        <el-input v-model="queryParams.sysDeptId" placeholder="请输入部门id" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="用户id" prop="sysUserId">
        <el-input v-model="queryParams.sysUserId" placeholder="请输入用户id" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['zlyyh:code:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['zlyyh:code:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['zlyyh:code:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['zlyyh:code:export']">导出</el-button>
      </el-col>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="核销状态：0-未核销，1-已核销，2-已失效，3-已作废" prop="usedStatus">
          <el-radio-group v-model="form.usedStatus">
            <el-radio v-for="dict in dict.type.t_code_used_status" :key="dict.value"
              :label="dict.value">{{dict.label}}</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="券码类型：0-系统券码，1-外部券码" prop="codeType">
          <el-select v-model="form.codeType" placeholder="请选择券码类型：0-系统券码，1-外部券码">
            <el-option v-for="dict in dict.type.t_code_type" :key="dict.value" :label="dict.label"
              :value="dict.value"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="核销或作废时间" prop="usedTime">
          <el-date-picker clearable v-model="form.usedTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss"
            placeholder="请选择核销或作废时间">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="核销店铺ID" prop="shopId">
        ...
        <el-form-item label="预约时间" prop="appointmentDate">
          <el-date-picker clearable v-model="form.appointmentDate" type="datetime" value-format="yyyy-MM-dd HH:mm:ss"
            placeholder="请选择预约时间">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="预约状态：0-未预约，1-已预约，2-已取消" prop="appointmentStatus">
          <el-radio-group v-model="form.appointmentStatus">
            <el-radio v-for="dict in dict.type.appointment_status" :key="dict.value"
              :label="dict.value">{{dict.label}}</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="预约时间ID" prop="appointmentId">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /** 导出按钮操作 */
      handleExport() {
        this.download('zlyyh-admin/code/export', {
          ...this.queryParams
