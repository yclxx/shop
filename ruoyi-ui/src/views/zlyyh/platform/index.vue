          ...
          <el-col :span="12">
            <el-form-item label="支持端" prop="supportChannel">
              <el-checkbox-group v-model="form.supportChannel">
                <el-checkbox @change="checked=>changeChannel(checked,item)" v-for="item in dict.type.channel_type"
        ...
        <el-row v-if="form.platformChannel">
          <div v-for="(item,index) in form.platformChannel" :key="index">
            <el-card>
              ...
              <el-col :span="6">
                <el-form-item label="支付商户号" :prop="'platformChannel.'+index+'.merchantId'"
              ...
              <el-col :span="6">
                <el-form-item label="小程序标题" align="center" :prop="'platformChannel.'+index+'.platformTitle'"
                  :rules="{required: true, message: '请输入小程序标题', trigger: 'blur'}">
                  <el-input v-model="item.platformTitle" placeholder="请输入小程序标题" />
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="appId" align="center" :prop="'platformChannel.'+index+'.appId'"
                  :rules="{required: true, message: '请输入appId', trigger: 'blur'}">
                  <el-input v-model="item.appId" placeholder="请输入appId" />
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="小程序ID" align="center" :prop="'platformChannel.'+index+'.encryptAppId'"
